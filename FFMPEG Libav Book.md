...
The official documentation is good as an API doc, but it doesn't explain concepts to a newbie. The examples too don't run on all files out of the box.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1Njk4MTgxNSwtNjA2OTMyMzI5LDE2OT
